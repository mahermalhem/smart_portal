...
export function EmpAddJob({navigation, route}) {
...
//       style={styles.item}
//       onPress={() => {
//         setSelectedCountry(title+","+section.title)
...
//   );
  ...
  const addNewJob = async formValues => {
    ...
    fetch('http://54.162.241.44/api/job/create-job/', {
      method: 'POST',
      headers: {
  ...
  var numOfLinesAddress = 0;
  var numOfLinesDescription = 0;
  return (
